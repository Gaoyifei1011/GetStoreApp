...
namespace GetStoreApp.Models
{
    ...
    /// </summary>
    public class HistoryRawModel : DependencyObject
    {
        /// <summary>
        ...
        public static readonly DependencyProperty CurrentTimeStampProperty =
            DependencyProperty.Register("CurrentTimeStamp", typeof(string), typeof(HistoryRawModel), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty HistoryKeyProperty =
            DependencyProperty.Register("HistoryKey", typeof(string), typeof(HistoryRawModel), new PropertyMetadata(string.Empty));
        ...
        public static readonly DependencyProperty HistoryTypeProperty =
            DependencyProperty.Register("HistoryType", typeof(string), typeof(HistoryRawModel), new PropertyMetadata(string.Empty));
        ...
        public static readonly DependencyProperty HistoryChannelProperty =
            DependencyProperty.Register("HistoryChannel", typeof(string), typeof(HistoryRawModel), new PropertyMetadata(string.Empty));
        ...
        public static readonly DependencyProperty HistoryLinkProperty =
            DependencyProperty.Register("HistoryLink", typeof(string), typeof(HistoryRawModel), new PropertyMetadata(string.Empty));
    }
}
