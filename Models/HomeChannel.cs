...
{
    public class HomeChannel : DependencyObject
    {
        ...
        public static readonly DependencyProperty DisplayNameProperty =
            DependencyProperty.Register("DisplayName", typeof(string), typeof(HomeChannel), new PropertyMetadata(""));
        ...
        public static readonly DependencyProperty InternalNameProperty =
            DependencyProperty.Register("InternalName", typeof(string), typeof(HomeChannel), new PropertyMetadata(""));
    }
}
