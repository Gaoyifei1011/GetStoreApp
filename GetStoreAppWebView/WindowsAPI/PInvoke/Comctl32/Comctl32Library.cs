...
namespace GetStoreAppWebView.WindowsAPI.PInvoke.Comctl32
{
    ...
    public static partial class Comctl32Library
    {
        ...
        public static partial bool SetWindowSubclass(nint hWnd, SUBCLASSPROC pfnSubclass, uint uIdSubclass, nint dwRefData);
        ...
        public static partial nint DefSubclassProc(nint hWnd, WindowMessage uMsg, nuint wParam, nint lParam);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public static partial bool RemoveWindowSubclass(nint hWnd, SUBCLASSPROC pfnSubclass, uint uIdSubclass);
    }
}
