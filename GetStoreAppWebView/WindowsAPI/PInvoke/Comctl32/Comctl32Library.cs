...
namespace GetStoreAppWebView.WindowsAPI.PInvoke.Comctl32
{
    /// <summary>
    /// Comctl32.dll 函数库
    /// </summary>
    internal static partial class Comctl32Library
    {
        ...
        internal static partial bool SetWindowSubclass(nint hWnd, SUBCLASSPROC pfnSubclass, uint uIdSubclass, nint dwRefData);
        ...
        internal static partial nint DefSubclassProc(nint hWnd, WindowMessage uMsg, nuint wParam, nint lParam);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static partial bool RemoveWindowSubclass(nint hWnd, SUBCLASSPROC pfnSubclass, uint uIdSubclass);
    }
}
