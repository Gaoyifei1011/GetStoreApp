...
namespace GetStoreAppShellExtension.Commands
{
    ...
    /// </summary>
    [GeneratedComClass]
    public partial class AppInformationCommand : IExplorerCommand
    {
        /// <summary>
        /// 根菜单标题
        /// </summary>
        ...
        {
            ppszName = ResourceService.GetLocalized("ShellMenu/AppInformation");
            return 0;
        }
        ...
        {
            ppszIcon = Path.Combine(InfoHelper.AppInstalledLocation, @"Assets\Icon\ShellMenu\AppInformation.ico");
            return 0;
        }
