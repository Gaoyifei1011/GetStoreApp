...
namespace GetStoreAppShellExtension.Commands
{
    ...
    /// </summary>
    [GeneratedComClass]
    internal sealed partial class PSInstallCommand : IExplorerCommand
    {
        private readonly string PSInstallString = ResourceService.GetLocalized("ShellMenu/PSInstall");
