...
namespace GetStoreAppHelper.WindowsAPI.PInvoke.Kernel32
{
    ...
    public unsafe partial struct STARTUPINFO
    {
        ...
        /// The offset is from the upper left corner of the screen. For GUI processes, the specified position is used the first time the new process calls InitializeWindow to create an overlapped window if the x parameter of InitializeWindow is CW_USEDEFAULT.
        /// </summary>
        public int dwX;
        ...
        /// The offset is from the upper left corner of the screen. For GUI processes, the specified position is used the first time the new process calls InitializeWindow to create an overlapped window if the y parameter of InitializeWindow is CW_USEDEFAULT.
        /// </summary>
        public int dwY;
        ...
        /// For GUI processes, this is used only the first time the new process calls InitializeWindow to create an overlapped window if the nWidth parameter of InitializeWindow is CW_USEDEFAULT.
        /// </summary>
        public int dwXSize;
        ...
        /// For GUI processes, this is used only the first time the new process calls InitializeWindow to create an overlapped window if the nHeight parameter of InitializeWindow is CW_USEDEFAULT.
        /// </summary>
        public int dwYSize;
