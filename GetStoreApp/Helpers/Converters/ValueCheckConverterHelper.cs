...
namespace GetStoreApp.Helpers.Converters
{
    ...
    internal static class ValueCheckConverterHelper
    {
        ...
        /// 检查是否支持显示分享面板
        /// </summary>
        internal static Visibility CheckShareUIVisibility()
        {
        ...
        /// 检查痕迹清理对话框按钮是否可用
        /// </summary>
        internal static bool IsTraceCleanupButtonEnabled(bool isSelected, bool isCleaning)
        {
        ...
        /// 检查商店应用安装状态
        /// </summary>
        internal static Visibility CheckAppInstallStateVisibility(AppInstallState appInstallState, AppInstallState comparedAppInstallState)
        {
        ...
        /// 检查商店应用类型
        /// </summary>
        internal static Visibility CheckPackageSignatureKindVisibility(PackageSignatureKind packageSignatureKind, PackageSignatureKind comparedPackageSignatureKind, bool needReverse)
        {
        ...
        /// 检查下载任务状态
        /// </summary>
        internal static Visibility CheckDownloadProgressStateVisibility(DownloadProgressState downloadProgressState, DownloadProgressState comparedDownloadProgressState)
        {
        ...
        /// 检查 WinGet 应用是否是下载状态
        /// </summary>
        internal static bool IsPackageDownloading(PackageDownloadProgressState packageDownloadProgressState)
        {
        ...
        /// 检查 WinGet 应用是否是安装状态
        /// </summary>
        internal static bool IsPackageInstalling(PackageInstallProgressState packageInstallProgressState)
        {
        ...
        /// 检查 WinGet 应用是否是卸载状态
        /// </summary>
        internal static bool IsPackageUninstalling(PackageUninstallProgressState packageUninstallProgressState)
        {
        ...
        /// 检查 WinGet 应用是否是修复状态
        /// </summary>
        internal static bool IsPackageRepairing(PackageRepairProgressState packageRepairProgressState)
        {
        ...
        /// 检查 WinGet 应用是否是更新状态
        /// </summary>
        internal static bool IsPackageUpgrading(PackageInstallProgressState packageInstallProgressState)
        {
            return packageInstallProgressState is PackageInstallProgressState.Queued || packageInstallProgressState is PackageInstallProgressState.Installing || packageInstallProgressState is PackageInstallProgressState.PostInstall;
        }
        ...
        /// 检查 WinGet 应用的下载状态
        /// </summary>
        internal static Visibility CheckPackageDownloadProgressStateVisibility(PackageDownloadProgressState packageDownloadProgressState, PackageDownloadProgressState comparedPackageDownloadProgressState, bool isReverse)
        {
        ...
        /// 检查 WinGet 应用的安装状态
        /// </summary>
        internal static Visibility CheckPackageInstallProgressStateVisibility(PackageInstallProgressState packageInstallProgressState, PackageInstallProgressState comparedPackageInstallProgressState, bool isReverse)
        {
        ...
        /// 检查 WinGet 应用的卸载状态
        /// </summary>
        internal static Visibility CheckPackageUninstallProgressStateVisibility(PackageUninstallProgressState packageUninstallProgressState, PackageUninstallProgressState comparedPackageUninstallProgressState, bool isReverse)
        {
        ...
        /// 检查 WinGet 应用的修复状态
        /// </summary>
        internal static Visibility CheckPackageRepairProgressStateVisibility(PackageRepairProgressState packageRepairProgressState, PackageRepairProgressState comparedPackageRepairProgressState, bool isReverse)
        {
        ...
        /// 检查 WinGet 应用的安装状态
        /// </summary>
        internal static Visibility CheckPackageUpgradeProgressStateVisibility(PackageInstallProgressState packageInstallProgressState, PackageInstallProgressState comparedPackageInstallProgressState, bool isReverse)
        {
            return isReverse ? Equals(packageInstallProgressState, comparedPackageInstallProgressState) ? Visibility.Collapsed : Visibility.Visible : Equals(packageInstallProgressState, comparedPackageInstallProgressState) ? Visibility.Visible : Visibility.Collapsed;
        }
        ...
        /// 检查 WinGet 应用的安装状态
        /// </summary>
        internal static Visibility CheckPackageOperationResultKindVisibility(PackageOperationResultKind packageOperationResultKind, PackageOperationResultKind comparedPackageOperationResultKind)
        {
        ...
        /// 检查列表控件选中项样式
        /// </summary>
        internal static Visibility CheckListViewSelectionModeVisibility(ListViewSelectionMode listViewSelectionMode, ListViewSelectionMode comparedListViewSelectionMode)
        {
