...
namespace GetStoreApp.UI.Notifications
{
    ...
    public sealed partial class ResultContentCopyNotification : UserControl
    {
        ...
        public ResultContentCopyNotification(bool copyState, [Optional, DefaultParameterValue(false)] bool isMultiSelected, [Optional, DefaultParameterValue(0)] int count, [Optional] double? duration)
        {
