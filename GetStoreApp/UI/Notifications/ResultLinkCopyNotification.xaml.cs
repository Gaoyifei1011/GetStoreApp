...
namespace GetStoreApp.UI.Notifications
{
    ...
    /// 请求结果链接复制应用内通知
    /// </summary>
    public sealed partial class ResultLinkCopyNotification : InAppNotification, INotifyPropertyChanged
    {
        private int Count = 0;
        ...
        public ResultLinkCopyNotification(FrameworkElement element, bool isMultiSelected = false, int count = 0) : base(element)
        {
            InitializeComponent();
