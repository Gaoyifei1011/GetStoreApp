...
namespace GetStoreApp.Views.Pages
{
    ...
    public sealed partial class AboutPage : Page
    {
        ...
        {
            new KeyValuePairModel(){ Key = "Microsoft.NET.ILLink.Analyzers",Value="https://github.com/dotnet/linker"},
            new KeyValuePairModel(){ Key = "Microsoft.NET.ILLink.Tasks",Value="https://github.com/dotnet/linker"},
