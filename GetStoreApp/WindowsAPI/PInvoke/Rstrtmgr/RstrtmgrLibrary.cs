...
{
    internal static partial class RstrtmgrLibrary
    {
        ...
        internal static partial int RmRestart(uint dwSessionHandle, RM_SHUTDOWN_TYPE dwRestartFlags, RM_WRITE_STATUS_CALLBACK fnStatus);
        ...
        internal static partial int RmShutdown(uint dwSessionHandle, RM_SHUTDOWN_TYPE lActionFlags, RM_WRITE_STATUS_CALLBACK fnStatus);
        ...
        internal static partial int RmStartSession(out uint pSessionHandle, int dwSessionFlags, [MarshalAs(UnmanagedType.LPWStr)] string strSessionKey);
        ...
        internal static partial int RmEndSession(uint pSessionHandle);
    }
}
