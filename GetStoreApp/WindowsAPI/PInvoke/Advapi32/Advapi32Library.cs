...
namespace GetStoreApp.WindowsAPI.PInvoke.Advapi32
{
    public static partial class Advapi32Library
    {
        ...
        public static partial int RegOpenKeyEx(IntPtr hKey, string lpSubKey, int ulOptions, RegistryAccessRights samDesired, ref IntPtr phkResult);
        ...
        public static partial int RegQueryValueEx(IntPtr hKey, string lpValueName, IntPtr lpReserved, IntPtr lpType, byte[] lpData, ref int lpcbData);
    }
}
