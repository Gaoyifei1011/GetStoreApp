...
namespace GetStoreApp.WindowsAPI.PInvoke.User32
{
    ...
    public static partial class User32Library
    {
        ...
        internal static partial bool ChangeWindowMessageFilterEx(IntPtr hWnd, WindowMessage message, ChangeFilterAction action, in CHANGEFILTERSTRUCT pChangeFilterStruct);
