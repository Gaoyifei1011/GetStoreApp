...
namespace GetStoreApp.WindowsAPI.PInvoke.Ole32
{
    ...
    /// Ole32.dll 函数库
    /// </summary>
    internal static partial class Ole32Library
    {
        ...
        internal static partial int CoCreateInstance(in Guid rclsid, nint pUnkOuter, CLSCTX dwClsContext, in Guid riid, out nint ppv);
        ...
        internal static partial int CoInitializeSecurity(nint pSecDesc, nint cAuthSvc, nint asAuthSvc, nint pReserved1, int dwAuthnLevel, int dwImpLevel, nint pAuthList, int dwCapabilities, nint pReserved3);
        ...
        internal static partial int CoSetProxyBlanket(nint punk, uint dwAuthnSvc, uint dwAuthzSvc, nint pServerPrincName, uint dwAuthLevel, uint dwImpLevel, nint pAuthInfo, uint dwCapabilities);
    }
}
