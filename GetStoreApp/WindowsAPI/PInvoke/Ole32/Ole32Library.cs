...
namespace GetStoreApp.WindowsAPI.PInvoke.Ole32
{
    ...
    public static partial class Ole32Library
    {
        ...
        public static partial int CoCreateInstance(in Guid rclsid, nint pUnkOuter, CLSCTX dwClsContext, in Guid riid, out nint ppv);
        ...
        public static partial int CoInitializeSecurity(nint pSecDesc, nint cAuthSvc, nint asAuthSvc, nint pReserved1, int dwAuthnLevel, int dwImpLevel, nint pAuthList, int dwCapabilities, nint pReserved3);
        ...
        public static partial int CoSetProxyBlanket(nint punk, uint dwAuthnSvc, uint dwAuthzSvc, nint pServerPrincName, uint dwAuthLevel, uint dwImpLevel, nint pAuthInfo, uint dwCapabilities);
    }
}
