...
namespace GetStoreApp.WindowsAPI.PInvoke.NTdll
{
    ...
    public static class NTdllLibrary
    {
        ...
        /// 当 ProcessInformationClass 参数为 <see cref="PROCESSINFOCLASS.ProcessBasicInformation"> 时，<param name="processInformation"> 参数指向的缓冲区应足够大
        /// </param>
        /// <param name="processInformationLength"><param name="processInformation"> 参数指向的缓冲区的大小（以字节为单位）。</param>
        /// <param name="returnLength">
        /// 指向函数返回所请求信息大小的变量的指针。 如果函数成功，则这是 由 <param name="processInformation"> 参数指向的缓冲区中写入的信息的大小，
