...
namespace GetStoreApp.Services.Root
{
    ...
    public static partial class LogService
    {
        ...
        /// 写入日志
        /// </summary>
        public static void WriteLog(LogType logType, string logContent, StringBuilder logBuilder)
        {
            if (IsInitialized)
            {
                try
        ...
        /// 写入日志
        /// </summary>
        public static void WriteLog(LogType logType, string logContent, Exception exception)
        {
            if (IsInitialized)
            {
                try
