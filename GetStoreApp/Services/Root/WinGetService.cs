...
namespace GetStoreApp.Services.Root
{
    ...
    {
        private static bool useDevVersion = false;

        /// <summary>
        /// 判断 WinGet 服务是否存在
        /// </summary>
        public static bool IsWinGetServiceExist()
        {
            return true;
        }

        public static void InitializeVersion(bool version)
        {
            useDevVersion = version;
        }
        ...
        // COM接口：IUnknown 接口
        private static Guid IID = new Guid("00000000-0000-0000-C000-000000000046");

        /// <summary>
        /// 创建包管理器
        /// </summary>
        public static unsafe PackageManager CreatePackageManager([Optional, DefaultValue(false)] bool useDev)
        {
            if (useDev)
            {
        ...
        /// 创建安装选项
        /// </summary>
        public static unsafe InstallOptions CreateInstallOptions([Optional, DefaultValue(false)] bool useDev)
        {
            if (useDev)
            {
        ...
        /// 嗯。。。暂时未知
        /// </summary>
        public static unsafe PackageMatchFilter CreatePacakgeMatchFilter([Optional, DefaultValue(false)] bool useDev)
        {
            if (useDev)
            {
