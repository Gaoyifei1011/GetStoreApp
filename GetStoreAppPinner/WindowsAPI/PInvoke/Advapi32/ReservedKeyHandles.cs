namespace GetStoreAppPinner.WindowsAPI.PInvoke.Advapi32
{
    /// <summary>
    /// 注册表保留键值的句柄
    /// </summary>
    internal static class ReservedKeyHandles
    {
        /// <summary>
        ...
        /// </summary>
        internal static readonly nuint HKEY_CLASSES_ROOT = new(0x80000000);
