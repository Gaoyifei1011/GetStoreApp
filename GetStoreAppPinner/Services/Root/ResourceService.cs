    ...
    public static class ResourceService
    {
        ...
        public static string GetLocalized(string resource)
        {
            if (isInitialized)
            {
                ...
                {
                    LogService.WriteLog(LoggingLevel.Error, nameof(GetStoreAppPinner), nameof(ResourceService), nameof(GetLocalized), 1, currentResourceException);
                    try
                    {
                    ...
                    {
                        LogService.WriteLog(LoggingLevel.Error, nameof(GetStoreAppPinner), nameof(ResourceService), nameof(GetLocalized), 2, defaultResourceException);
                        return resource;
                    }
                }
            }
            ...
            {
                LogService.WriteLog(LoggingLevel.Error, nameof(GetStoreAppPinner), nameof(ResourceService), nameof(GetLocalized), 3, new Exception());
                return resource;
            }
        }
    }
