using GetStoreAppPinner.Extensions.DataType.Constant;
...
namespace GetStoreAppPinner.Services.Settings
{
    /// <summary>
    /// 应用语言设置服务
    /// </summary>
    public static class LanguageService
    {
        ...
        public static void InitializeLanguage()
        {
            ...
            CultureInfo.DefaultThreadCurrentUICulture = new(AppLanguage);
