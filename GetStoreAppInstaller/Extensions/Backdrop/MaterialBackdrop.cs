...
namespace GetStoreAppInstaller.Extensions.Backdrop
{
    ...
    internal sealed partial class MaterialBackdrop : SystemBackdrop
    {
        ...
        protected override void OnTargetConnected(ICompositionSupportsSystemBackdrop connectedTarget, XamlRoot xamlRoot)
        {
            ...
            {
                LogService.WriteLog(LoggingLevel.Warning, nameof(GetStoreAppInstaller), nameof(MaterialBackdrop), nameof(OnTargetConnected), 1, new Exception());
        ...
        /// <summary>
        /// 重写此方法，以便在 GetDefaultSystemBackdropConfiguration 返回的对象发生变化后调用
        /// </summary>
