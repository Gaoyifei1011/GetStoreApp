...
namespace GetStoreAppInstaller.WindowsAPI.PInvoke.SHCore
{
    public static partial class ShCoreLibrary
    {
        ...
        public static partial int CreateRandomAccessStreamOverStream([MarshalAs(UnmanagedType.Interface)] IStream stream, BSOS_OPTIONS options, Guid riid, out IntPtr ppv);
