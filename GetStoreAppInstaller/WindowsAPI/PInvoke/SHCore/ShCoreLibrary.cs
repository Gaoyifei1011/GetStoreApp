...
{
    internal static partial class ShCoreLibrary
    {
        ...
        internal static partial int CreateRandomAccessStreamOverStream([MarshalAs(UnmanagedType.Interface)] IStream stream, BSOS_OPTIONS options, Guid riid, out nint ppv);
        ...
        internal static partial int CreateStreamOverRandomAccessStream(nint randomAccessStream, Guid riid, [MarshalAs(UnmanagedType.Interface)] out IStream ppv);
    }
}
