...
namespace GetStoreAppInstaller.WindowsAPI.ComTypes
{
    ...
    public partial interface IAppxFactory
    {
        ...
        /// <returns>如果方法成功，则返回 S_OK。 否则，它将返回一个错误代码。</returns>
        [PreserveSig]
        int CreateManifestReader([MarshalAs(UnmanagedType.Interface)] IStream inputStream, [MarshalAs(UnmanagedType.Interface)] out IAppxManifestReader3 manifestReader);
