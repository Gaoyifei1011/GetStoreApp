...
namespace GetStoreAppInstaller.WindowsAPI.ComTypes
{
    ...
    /// 枚举包清单中定义的资源。
    /// </summary>
    [GeneratedComInterface, Guid("DE4DFBBD-881A-48BB-858C-D6F2BAEAE6ED")]
    public partial interface IAppxManifestResourcesEnumerator
    {
        /// <summary>
        /// 获取枚举器当前位置的资源。
        /// </summary>
        /// <param name="resource">当前资源。</param>
